...
export function Noveldetailpage() {
    ...
    // 🌟 1. ดึง ID ผู้ใช้จาก Token (คงไว้ตามเดิม)
    useEffect(() => {
    ...
    // 🌟 2. ดึงข้อมูลนิยายและตอนต่างๆ (คงไว้ตามเดิม)
    useEffect(() => {
    ...
    // 🌟 3. ดึงสถานะ Bookmark (คงไว้ตามเดิม)
    useEffect(() => {
        if (isLoggedIn && id) {
    ...
    // 🌟 4. ฟังก์ชันกด Bookmark (คงไว้ตามเดิม)
