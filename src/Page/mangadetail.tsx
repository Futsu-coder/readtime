...
// --- Styles ---
const pageWrapper: React.CSSProperties = { backgroundColor: '#ffffff', minHeight: '100vh', width: '100%', margin: 0, padding: '1px 0' };
...
// Style จากหน้าหลักเดิมที่ไม่มีใน Test ปรับให้เข้ากับธีมม่วงของ Test เล็กน้อย
