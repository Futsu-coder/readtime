    ...
    return (
        <div style={{ backgroundColor: '#ffffff', minHeight: '100vh', fontFamily: "'Sarabun', sans-serif" }}>
            <div style={{ 
                ...
                <Link to={`/manga/${id}`} style={{ color: '#666', textDecoration: 'none', fontWeight: 'bold' }}>
                    &larr; กลับไปสารบัญ
                </Link>
                ...
                <div style={{ color: '#333', textAlign: 'center' }}>
                    ...
                    <span style={{ fontSize: '0.9rem', color: '#666' }}>{chapter.title}</span>
                </div>
            ...
            <div style={{ 
                ...
                <button 
                    ...
                    style={{ 
                        ...
                        padding: '12px 25px', cursor: 'pointer', background: '#f5f5f5', 
                ...
                <button 
                    ...
                    style={{ 
                        ...
                        boxShadow: '0 4px 15px rgba(201, 139, 242, 0.3)'
                    }}
                >
                    ตอนต่อไป &rarr;
                </button>
